          ...
          <form onSubmit={handleAdd}>
            <div className="formGrid">
              ...
              <div className="field formGridFull">
                ...
                <textarea name="description" className="textarea" placeholder="Brief description for homepage card…" />
              </div>
            </div>
                ...
                >
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <Link href={`/admin/pages/${p.id}/edit`} className="btnGhost" style={{ padding: '6px 12px' }}>Edit</Link>
